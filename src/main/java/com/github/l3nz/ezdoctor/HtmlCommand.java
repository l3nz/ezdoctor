...
public class HtmlCommand implements Runnable {
    ...
    @Option(names = "--theme", paramLabel = "<name>", description = "Theme name or path to a theme file (.css)")
    String theme;
    ...
    public void run() {
        ...
        File out = Engine.convert(args.input, args.output, "html5", ".html", theme, args.rev);
